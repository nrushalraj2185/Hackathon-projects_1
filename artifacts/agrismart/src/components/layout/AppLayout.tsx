...
import { 
  ...
  Radio, Bell, Menu, X, Globe, WifiOff
} from 'lucide-react';
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center bg-white border border-border rounded-full p-1 shadow-sm">
              <button 
                ...
                className={`px-3 py-1 text-xs font-bold rounded-full transition-all ${language === 'en' ? 'bg-primary text-primary-foreground shadow-md' : 'text-muted-foreground hover:bg-muted'}`}
              >
                EN
              </button>
              <button 
                onClick={() => setLanguage('hi')}
                className={`px-3 py-1 text-xs font-bold rounded-full transition-all ${language === 'hi' ? 'bg-primary text-primary-foreground shadow-md' : 'text-muted-foreground hover:bg-muted'}`}
              >
                हिंदी
              </button>
            </div>
